...
db.session.add(Wiki(wiki_post="this is a post", page_name="testpage", user_id=1))
db.session.add(Wiki(wiki_post="another test post", page_name="testpage2", user_id=1))
